...
### Build a Gaussian pyramid from one image
...
### Build a Gaussian pyramid from the secoond image
#### Like the first image, I used the 'scipy.ndimage.filters.convolve' in order to blur the image
<p align="center">
